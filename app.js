...
function sumArray(testArray){ //eslint-disable-line
  var threeSum = sum(sum(testArray[0],testArray[1])[0],testArray[2])[0];
  var fourMessage = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + threeSum + ' is their sum.'
  return [threeSum, fourMessage];
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var threeProduct = multiply(multiply(testArray[0],testArray[1])[0],testArray[2])[0];
  var fiveMessage = ('The numbers ' + testArray + ' have a product of ' + threeProduct + '.' );
//  console.log(threeProduct, fiveMessage);
//  if (fiveMessage === 'The numbers 2,3,4 have a product of 24.'){
//    console.log('YES');
//  }
  return [threeProduct, fiveMessage];
